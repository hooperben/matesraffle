...
const Banner = () => {
  return (
    ...
    >
      <NeonGradientCard className="text-left max-w-[300px] md:max-w-[400px] m-1">
        <div className="pointer-events-none z-10 h-full whitespace-pre-wrap bg-gradient-to-br from-[#800080] from-35% to-[#595959] bg-clip-text text-4xl font-bold leading-none tracking-tighter text-transparent dark:drop-shadow-[0_5px_5px_rgba(0,0,0,0.8)]">
